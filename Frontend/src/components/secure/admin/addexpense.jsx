      ...
      <div className="bg-gradient-to-br from-gray-900 to-gray-950 rounded-xl sm:rounded-2xl shadow-2xl border border-gray-800 w-full max-w-2xl max-h-[95vh] sm:max-h-[90vh] overflow-y-auto scrollbar-hide">
        ...
        <div className="sticky top-0 bg-gray-900 border-b border-gray-800 p-4 sm:p-5 md:p-6 flex items-center justify-between rounded-t-xl sm:rounded-t-2xl z-50 shadow-xl">
          <div className="flex items-center gap-2 sm:gap-3 min-w-0">
            ...
            <h2 className="text-xl sm:text-2xl font-bold text-white truncate">Add Expense</h2>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-4 sm:p-5 md:p-6 space-y-4 sm:space-y-5 md:space-y-6">
              ...
              {members.map((member, index) => (
                ...
                >
                  <input
                    ...
                    className="w-4 h-4 sm:w-5 sm:h-5 rounded border-gray-600 text-green-700 focus:ring-green-700 focus:ring-offset-gray-800 disabled:opacity-50 flex-shrink-0"
                  />
                  ...
                  {paidBy.find(p => p.name === member.name) && (
                    <input
                      ...
                      disabled={isPaidEqually}
                      className="w-20 sm:w-24 px-2 sm:px-3 py-1.5 sm:py-2 rounded-lg border-2 border-gray-600 bg-gray-900 text-white text-sm sm:text-base text-right focus:outline-none focus:border-green-700 transition-all duration-300 disabled:opacity-50 flex-shrink-0"
                    />
                  )}
                </div>
              ))}
          ...
          <div>
            <div className="flex items-center justify-between mb-2 sm:mb-3">
              ...
              <button
                ...
                disabled={isPaidEqually}
                className="text-xs sm:text-sm bg-gray-800 hover:bg-gray-700 text-green-700 px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg transition-all duration-300 disabled:opacity-50 active:scale-[0.98]"
              >
                Split Equally
              </button>
            </div>
          ...
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 pt-2 sm:pt-4">
            ...
            <button
              ...
              disabled={loading}
              className="w-full sm:flex-1 bg-gradient-to-r from-green-700 to-green-600 hover:text-black  text-white font-semibold py-2.5 sm:py-3 rounded-lg sm:rounded-xl transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg  text-sm sm:text-base active:scale-[0.98]"
            >
