  ...
  return (
    <div id='home'className="flex flex-col md:flex-row md:top-16 items-center justify-between p-6 bg-black min-h-screen">
      <div className="text-white md:w-1/2 p-4">
        <h1 className="text-4xl md:text-6xl pt-6 font-bold mb-4">Split your <span className="text-green-700">money</span></h1>
        ...
        <div className='flex gap-5'>
          <Link to="/login">
          <button className="bg-transparent border-2 border-green-700 text-green-700 px-4 py-2 rounded-md hover:bg-green-700 hover:text-black">Login</button>

          </Link>
          <Link to="/register">
          <button className="bg-transparent border-2 border-green-700 text-green-700 px-4 py-2 rounded-md hover:bg-green-700 hover:text-black">Register</button>
